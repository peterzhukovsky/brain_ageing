...
for roi=1:length(rlabel_names)
    ...
    tstat_relative=1-tstat_roi(roi+180)/(max(tstat_roi)+0.001);
    ...
    tstat_relative=1-tstat_roi(roi+180)/(min(tstat_roi)-0.001);
    color_relative=round(tstat_relative*256);
...
for roi=1:length(rlabel_names)
    ...
    tstat_relative=1-tstat_roi(roi)/(max(tstat_roi)+0.001);
    color_relative=round(tstat_relative*256);
    ...
    elseif tstat_roi(roi)<0;
        red_range=0:255;
        green_range=183.5:0.28:255;
    tstat_relative=1-tstat_roi(roi)/(min(tstat_roi)-0.001);
    color_relative=round(tstat_relative*256);
